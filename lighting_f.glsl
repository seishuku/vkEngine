...
void main()
{
	...
	temp.xyz =(l0_diffuse+l0_specular)*l0_atten*(1.0-l0_volume.w)+(l0_volume.w*Light0_Kd.rgb);
	temp.xyz+=(l1_diffuse+l1_specular)*l1_atten*(1.0-l1_volume.w)+(l1_volume.w*Light1_Kd.rgb);
	temp.xyz+=(l2_diffuse+l2_specular)*l2_atten*(1.0-l2_volume.w)+(l2_volume.w*Light2_Kd.rgb);

	temp.xyz =(Base.rgb*l0_diffuse+l0_specular)*l0_atten*(1.0-l0_volume.w)+(l0_volume.w*Light0_Kd.rgb);
	temp.xyz+=(Base.rgb*l1_diffuse+l1_specular)*l1_atten*(1.0-l1_volume.w)+(l1_volume.w*Light1_Kd.rgb);
	temp.xyz+=(Base.rgb*l2_diffuse+l2_specular)*l2_atten*(1.0-l2_volume.w)+(l2_volume.w*Light2_Kd.rgb);
